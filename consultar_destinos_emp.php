              ...
              <ul class="nav nav-tabs nav-justified">
                ...
                <div style="padding:25px;"></div>
                  <div class="col-md-10" style="margin-left:250px;"> 
                    ...
                    <form name="formulario" role="form" method="POST" action="filtro_destinos_emp.php" onsubmit="return validacion()">
                       ...
                       <div class="col-xs-7">
                        ...
                        <div class="form-group">                                 
                          <div class="col-md-offset-3 col-md-9" style="margin:25px; margin-left:130px;"> 
                            ...
                            <input id="btn-volver" class="btn btn-lg" type="button" onclick="location.href='inicio_emp.php'" value='Volver'>
                          </div>      
                        </div>
