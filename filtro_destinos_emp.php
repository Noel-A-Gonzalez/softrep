          ...
          <div class="panel-heading"><center><strong></strong></center></div>
            ...
            <div class="panel-body">    
              <ul class="nav nav-tabs nav-justified">
                <li class="active"><a href="consultar_destinos_emp.php"><i style="margin-right: 6px" class="fa fa-bus fa-lg"></i> <big><strong>Consultar Destino</strong> </big></a></li>
...
$consulta="SELECT f.fecha, d.descripcion,h.hora,d.salida FROM destinos d INNER JOIN dest_fecha_hora a ON d.id_destino=a.id_destino INNER JOIN fechas f ON a.id_fecha=f.id_fecha INNER JOIN horas h ON h.id_hora = a.id_hora WHERE d.id_destino=$destino AND f.id_fecha=$fecha";
...
?>
    ...
    <center><input id="btn-volver" class="btn" type="button" onclick="location.href='consultar_destinos_emp.php'" value='Volver'></center>
